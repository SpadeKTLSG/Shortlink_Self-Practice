  ...
  <div>
    <el-form ref="ruleFormRef" :model="formData" :rules="formRule" label-width="80px">
      ...
      <el-form-item label="描述信息" prop="describe">
        <el-input v-model="formData.describe" :rows="4" placeholder="可通过换行创建多个短链，一行一个，单次最多创建50条" type="textarea"/>
      ...
      <el-form-item v-if="formData.validDateType === 1" label="选择时间">
        <el-date-picker v-model="formData.validDate" :disabled-date="disabledDate" :shortcuts="shortcuts"
                        placeholder="选择日期" type="datetime" value-format="YYYY-MM-DD HH:mm:ss"/>
